...
def load_data():
    ...
    global adj_list_forward, adj_list_backward, link_distributions, data_loaded
    ...
    try:
        ...
        if mode == 'forward':
            ...
            solver = ForwardLabelSettingSolver(
                ...
                L1=50, L2=10, K=100, verbose=False
            )
        ...
        if result and result.get('success'):
            ...
            print(f"✓ 求解成功:  {len(result['path'])} 个节点")
            print(f"✓ 求解耗时: {result['total_time']:.2f}秒")
            print(f"{'='*60}\n")
